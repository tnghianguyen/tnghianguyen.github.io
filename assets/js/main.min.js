'use strict';window.addEventListener("storage",a=>{"preference-theme"===a.key&&("light"===a.newValue?g("light",!0,!1):"dark"===a.newValue&&g("dark",!0,!1))});window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",a=>{!0!==a.matches?g("light"):g("dark")});document.querySelector("#dark-toggle-box").addEventListener("change",function(){this.checked?g("dark",!0,!0,!0):g("light",!0,!0,!0)});h();var k;
{const a=localStorage.getItem("preference-theme");k="light"===a?"light":"dark"===a?"dark":void 0}g(k||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),!1);function l(){return document.querySelector("#dark-toggle-box").checked?"dark":"light"}function m(a){document.querySelector("#dark-toggle-box").checked="dark"===a}
...
if(v){const a=Array.from(v.querySelectorAll("li")).map(function(d){const f=d.querySelector("a"),c=f.getAttribute("href").slice(1),r=document.getElementById(c);return{i:d,anchor:f,g:c,target:r,h:r.offsetTop}});function b(d){return d.reduce((f,c)=>window.pageYOffset+70>c.h?c:f)}const e=function(d={}){let f=d;return function(c){c.g!==f.g&&(f.g&&f.anchor.classList.remove("active"),c.anchor.classList.add("active"),f=c)}}();window.addEventListener("scroll",()=>e(b(a)))};
